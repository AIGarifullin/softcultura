# Проект от Софт Культура - внешнее решение-интеграция в виде amoCRM для REST API Софт Культуры. Обращение к API происходит обычным POST- или GET-запросом с заранее предоставленным ключом аутентификации в заголовке.
